...
public class EnemyEmitter {
    ...
    public EnemyEmitter(TextureAtlas atlas, EnemyPool enemyPool, Rect worldBounds) {
        ...
        this.enemySmallRegion = com.ttgantitg.utils.Regions.split(textureRegion, 1,2,2);
        TextureRegion textureRegion1 = atlas.findRegion("enemy1");
        this.enemyMediumRegion = com.ttgantitg.utils.Regions.split(textureRegion1, 1, 2, 2);
