...
public class Base2DScreen implements Screen, InputProcessor {
    ...
    private com.ttgantitg.math.Rect screenBounds; // границы области рисования в пикселях
    protected com.ttgantitg.math.Rect worldBounds; // границы проекции мировых координат
    private com.ttgantitg.math.Rect glBounds; // дефолтные границы проекции мир - gl
    ...
    public void show() {
        ...
        this.screenBounds = new com.ttgantitg.math.Rect();
        this.worldBounds = new com.ttgantitg.math.Rect();
        this.glBounds = new com.ttgantitg.math.Rect(0,0, 1f, 1f);
    ...
    public void resize(int width, int height) {
        ...
        com.ttgantitg.math.MatrixUtils.calcTransitionMatrix(worldToGl, worldBounds, glBounds);
