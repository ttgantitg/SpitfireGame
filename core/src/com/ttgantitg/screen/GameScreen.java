...
public class GameScreen extends Base2DScreen {
    ...
    private com.ttgantitg.sprite.Cloud[] clouds;
    private MainShip mainShip;
    private BulletPool bulletPool;
    private com.ttgantitg.pool.ExplosionPool explosionPool;
    private com.ttgantitg.pool.EnemyPool enemyPool;
    private com.ttgantitg.utils.EnemyEmitter enemyEmitter;
    private Music music;
    private State state;
    private enum State {PLAY, GAME_OVER, PAUSE, RESUME}
    private GameOver gameOver;
    private RestartButton restartButton;
    private com.ttgantitg.utils.Font font;
    ...
    public void show() {
        ...
        clouds = new com.ttgantitg.sprite.Cloud[CLOUDS_COUNT];
        for (int i = 0; i < clouds.length; i++) {
            clouds[i] = new com.ttgantitg.sprite.Cloud(textureAtlas);
        }
    ...
    public void resize(Rect worldBounds) {
        ...
        for (com.ttgantitg.sprite.Cloud cloud : clouds) {
    ...
    private void checkCollisions() {
        if (state == State.PLAY) {
            List<com.ttgantitg.sprite.game.Enemy> enemyList = enemyPool.getActiveObjects();
            for (com.ttgantitg.sprite.game.Enemy enemy : enemyList) {
            ...
            List<com.ttgantitg.sprite.game.Bullet> bulletList = bulletPool.getActiveObjects();

            for (com.ttgantitg.sprite.game.Bullet bullet : bulletList) {
